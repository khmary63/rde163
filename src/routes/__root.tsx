...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Каталог 5 000+ позиций, 8 складов по РФ, персональные цены для юрлиц. Заявка менеджеру за 30 секунд." },
      { name: "author", content: "ООО «Русский Дом Экспорта»" },
      { property: "og:title", content: "РДЭ — запчасти для китайской спецтехники" },
      { property: "og:description", content: "Каталог 5 000+ позиций, 8 складов по РФ, персональные цены для юрлиц. Заявка менеджеру за 30 секунд." },
      ...
      { name: "twitter:description", content: "Каталог 5 000+ позиций, 8 складов по РФ, персональные цены для юрлиц. Заявка менеджеру за 30 секунд." },
