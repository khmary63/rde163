...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    seoTitle: "Подбор запчастей для китайской спецтехники по артикулу",
    excerpt:
      "Алгоритм точного подбора деталей для китайской спецтехники по артикулу: где искать каталожный номер, как сверить с прайсом и проверить наличие на складе.",
    seoDescription:
      "Пошаговый подбор запчастей для китайской спецтехники по артикулу: где найти номер, как сверить с прайсом и быстро уточнить наличие на складе.",
    keywords: ["подбор запчастей по артикулу", "запчасти китайская спецтехника", "каталожный номер", "SDLG", "XCMG"],
    category: "Как подобрать запчасть",
    date: "2026-05-10",
  ...
  },
  {
    ...
    seoTitle: "Оригинал или аналог запчастей SDLG, XCMG, Shantui",
    excerpt:
      "Разбираем на конкретных примерах для SDLG, XCMG и Shantui, когда аналог сэкономит до 40%, а когда обернётся простоем и дорогим ремонтом узлов.",
    seoDescription:
      "Когда стоит брать аналог запчастей SDLG, XCMG и Shantui, а когда только оригинал: разбор по узлам, экономия до 40% и риски простоя техники.",
    keywords: ["запчасти SDLG", "запчасти XCMG", "запчасти Shantui", "оригинал или аналог", "аналоги запчастей"],
    category: "Оригинал или аналог",
    date: "2026-05-03",
  ...
  },
  {
    ...
    seoTitle: "Типовые неисправности фронтального погрузчика SDLG L956",
    excerpt:
      "Топ-7 типовых неисправностей фронтального погрузчика SDLG L956 по статистике сервисных центров за 2025 год: причины, признаки и стоимость ремонта.",
    seoDescription:
      "7 частых неисправностей SDLG L956 по статистике сервисов за 2025 год: перегрев гидросистемы, износ катков, отказ стартера зимой — причины и решения.",
    keywords: ["SDLG L956", "неисправности SDLG", "фронтальный погрузчик SDLG", "ремонт SDLG L956", "запчасти SDLG L956"],
