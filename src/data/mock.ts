...
export const reviews: Review[] = [
  {
    id: "r-1",
    author: "Олег Андриянов",
    rating: 5,
    date: "2025-11-01",
    text: "По возможности всегда стараемся заехать в этот сервис, почему? Да все просто, здесь работают адекватные специалисты, без лжи и фальши, запчасти оригинал и цены очень даже приемлемые, работы по замене проводят быстро, рекомендации дают только по теме, очень доволен их работой, и всем рекомендую этот сервис, спасибо.",
    source: "yandex",
  },
  {
    id: "r-2",
    ...
    rating: 5,
    date: "2025-03-27",
    text: "Отличные ребята, купили манипулятор у них, все пришло без опозданий, сдали предпродажную подготовку, все отлично, рекомендую! Установили сразу же допы, все оперативно и в наличии, обслуживаться тоже сюда приедем)",
    source: "yandex",
  },
  {
    id: "r-3",
    author: "Александр Паркаев",
    rating: 5,
    date: "2025-02-03",
    text: "Хороший центр, отличный персонал, работаем не первый год, понимают с полуслова — что нужно! Покупаем машины, обслуживаем, дооснащаем всё у них.",
    source: "yandex",
  },
  {
    id: "r-4",
    author: "Игорь Трифонов",
    rating: 5,
    date: "2024-07-26",
    text: "Профессионалы во всем! Искал запчасти на Ситрак. Почти отчаялся найти необходимое в привычных для себя местах. К своему удивлению обнаружил здесь на складе несколько дефицитных позиций. К тому же по хорошей цене. Очень быстрый ответ, грамотные ребята, сработали чётко и качественно. Рекомендую!",
    source: "yandex",
  },
];
